...
export const UserContext = ({ children }) => {
    ...
    const handleLogin = async ({ dni }) => {
        await axios.post(`http://ec2-52-22-149-124.compute-1.amazonaws.com/api/participante/consulta`, {
            "dni": dni
        }, {
            method: 'POST',
    ...
    const getQuestions = async () => {
        await axios.post(`http://ec2-52-22-149-124.compute-1.amazonaws.com/api/getPreguntas`, {
            "dni": respuesta?.dni
        }, {
            method: 'POST',
            headers: {
    ...
    const postQuestions = async () => {
        await axios.post(`http://ec2-52-22-149-124.compute-1.amazonaws.com/api/intentos/guardar`, {
